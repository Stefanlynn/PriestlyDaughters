                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <div className="relative flex-1">
                      <input
                        ...
                        className="w-full h-12 px-5 border-b-2 border-tan-dark/30 bg-transparent focus:outline-none focus:border-tan-dark transition-all"
                      />
                      <div className="absolute inset-0 bg-tan-light/20 -z-10 rounded-tl-lg rounded-tr-lg"></div>
                    </div>
                    
                    <button 
                      type="submit" 
                      disabled={isSubmitting}
                      className="h-12 bg-tan-dark hover:bg-tan-dark/90 text-white rounded-full px-8 shadow-sm hover:shadow transition-all flex items-center justify-center sm:w-auto"
                    >
                      {isSubmitting ? (
