      ...
      <main className="flex-grow pt-32 md:pt-40 pb-20">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-sm p-8 md:p-12 text-center">
            ...
            <h1 className="font-cursive text-4xl md:text-5xl text-tan-dark mb-4">
              You're on the List!
            </h1>
            
            <p className="text-lg text-charcoal/80 mb-6">
              Thank you for subscribing to our newsletter. You'll be the first to receive updates, 
              special content, and invitations to our community events.
            </p>
